...
public class DistrictController {
	...
	@ResponseBody
	public List<DistrictResponse> getDistrictsByConcertId(@PathVariable("concertId") Long concertId) {
		List<District> districtList = districtService.findListByConcertId(concertId);
		return districtList.stream()
				.map(district -> DistrictResponse.of(district))
	...
	@ResponseStatus(HttpStatus.OK)
	@ResponseBody
	public DistrictResponse getDistrict(@PathVariable("districtId") Long districtId) {
		District district = districtService.findById(districtId);
		return DistrictResponse.of(district);
	}
}
